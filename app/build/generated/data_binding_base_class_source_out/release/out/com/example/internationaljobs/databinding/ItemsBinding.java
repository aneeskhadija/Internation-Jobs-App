...
public final class ItemsBinding implements ViewBinding {
  ...
  private ItemsBinding(@NonNull RelativeLayout rootView, @NonNull ImageView arrowImg,
  ...
  public static ItemsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemsBinding((RelativeLayout) rootView, arrowImg, company, dateTxt, job,
          newjobCard);
    }
