package com.example.internationaljobs;
...
public class MyApplication extends Application implements ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    public void onCreate() {
        ...
        Toast.makeText(getApplicationContext(), "Load ads", Toast.LENGTH_SHORT).show();
    ...
    private static class AppOpenAdManager {
        ...
        private static final String AD_UNIT_ID = "ca-app-pub-6035481626535720/7305821596";
