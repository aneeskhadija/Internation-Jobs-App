...
public class CountryCodePicker extends RelativeLayout {
  ...
  private void init(AttributeSet attrs) {
    ...
    CardView cardView=findViewById(R.id.lnCard);
    cardView.setOnClickListener(mCountryCodeHolderClickListener);
  }
  ...
  public void setDefaultCountryUsingName(@NonNull String countryName) {
    Country defaultCountry = CountryUtils.getByNameFromAllCountries(getContext(), countryName);
  ...
  public void setDefaultCountryUsingNameAndApply(@NonNull String countryIso) {
    Country defaultCountry = CountryUtils.getByNameFromAllCountries(getContext(), countryIso);
